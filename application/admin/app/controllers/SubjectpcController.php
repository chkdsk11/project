...
class SubjectpcController extends ControllerBase
{
    ...
    public function uploadAction()
    {
        ...
        {
            $res = BaseService::getInstance()->uploadFile($this->request, $this->config['application']['uploadDir'].'images/subjectpc/');
    ...
    {
		//模版文件
		$fileurl =  APP_PATH.'/static/assets/subjecttpl/pc.html' ;
		if($this->request->isPost()){
            $this->view->disable();
            $param = $this->postParam($this->request->getPost(), 'trim');
			$param['file'] = $fileurl;
