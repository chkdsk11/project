                    ...
                    <div>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="center" style="width:25%;">属性1</th>
                                <th class="center" style="width:25%;">属性2</th>
                                <th class="center" style="width:25%;">
                                    属性3
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <div name="1">
                                        ...
                                        {% if v[0]['productRule']['name_id']['name'] is defined %}{{ v[0]['productRule']['name_id']['name'] }}{% endif %}
                                        </span>
                                        <a name="{{ v[0]['id'] }}" href="javascript:;" id="{% if v[0]['productRule']['name_id']['id'] is defined %}{{ v[0]['productRule']['name_id']['id'] }}{% endif %}" class="editProductRule">编辑</a>
                                    </div>
                                </td>
                                <td class="center">
                                    <div name="2" class="clearfix"><span class="productRule">
                                    {% if v[0]['productRule']['name_id2']['name'] is defined %}{{ v[0]['productRule']['name_id2']['name'] }}{% endif %}</span>
                                        <a name="{{ v[0]['id'] }}" href="javascript:;" id="{% if v[0]['productRule']['name_id2']['id'] is defined %}{{ v[0]['productRule']['name_id2']['id'] }}{% endif %}" class="editProductRule">编辑</a>
                                        </div>
                                </td>
                                <td class="center">
                                    <div name="3"><span class="productRule">
                                    {% if v[0]['productRule']['name_id3']['name'] is defined %}{{ v[0]['productRule']['name_id3']['name'] }}{% endif %}</span>
                                    <a name="{{ v[0]['id'] }}" href="javascript:;" id="{% if v[0]['productRule']['name_id3']['id'] is defined %}{{ v[0]['productRule']['name_id3']['id'] }}{% endif %}" class="editProductRule">编辑</a>
                                    </div>
                                </td>
                            </tr>
                            {% endfor %}
                                ...
                                if(msg['data'].length > 0){
                                    for(var i = 0;i < msg['data'].length;i++){
                                        ...
                                        if(msg['data'][i]['productRule'] != undefined){
                                            if(msg['data'][i]['productRule']['name_id'] != undefined){
                                                html_list += "<td  class='center'><div name='1'><span class='productRule'>" + msg['data'][i]['productRule']['name_id']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                            }else{
                                            ...
                                            if(msg['data'][i]['productRule']['name_id2'] != undefined){
                                                html_list += "<td class='center'><div name='2'><span class='productRule'>" + msg['data'][i]['productRule']['name_id2']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id2']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                            }else{
                                            ...
                                            if(msg['data'][i]['productRule']['name_id3'] != undefined){
                                                html_list += "<td class='center'><div name='3'><span class='productRule'>" + msg['data'][i]['productRule']['name_id3']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id3']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                            }else{
                ...
                success: function(msg){
                    ...
                    if(msg['data'].length > 0) {
                        for (var i = 0; i < msg['data'].length; i++) {
                            ...
                            if (msg['data'][i]['productRule'] != undefined) {
                                if (msg['data'][i]['productRule']['name_id'] != undefined) {
                                    html += "<td class='center'><div name='1'><span class='productRule'>" + msg['data'][i]['productRule']['name_id']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                } else {
                                ...
                                if (msg['data'][i]['productRule']['name_id2'] != undefined) {
                                    html += "<td class='center'><div name='2'><span class='productRule'>" + msg['data'][i]['productRule']['name_id2']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id2']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                } else {
                                ...
                                if (msg['data'][i]['productRule']['name_id3'] != undefined) {
                                    html += "<td class='center'><div name='3'><span class='productRule'>" + msg['data'][i]['productRule']['name_id3']['name'] + "</span><a name='" + msg['data'][i]['id'] + "' href='javascript:;' id='" + msg['data'][i]['productRule']['name_id3']['id'] + "' class='editProductRule'>编辑</a></div></td>";
                                } else {
