                        ...
                        <div class="checkbox">
                            {% if shopPlatform is defined and shopPlatform is not empty %}
								{% for key,platform in shopPlatform %}
									...
									<label>
										<input name="use_platform[]" type="checkbox" class="ace" value="{% if key === 'pc' %}1{% elseif key === 'app' %}2{% elseif key === 'wechat' %}4{% else %}3{% endif %}" {% if edit_info['info'][selPlatform] == "1" %}checked{% endif %}>
