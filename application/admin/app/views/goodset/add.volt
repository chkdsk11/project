...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" id="insert_good_set" method="post" action="/goodset/add" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="group_name" name="group_name" placeholder="此处输入组合名称" class="col-xs-10 col-sm-5">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <textarea id="group_introduction" name="group_introduction" class="form-control" placeholder="此处输入组合描述"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="start_time" name="start_time" class="col-xs-10 col-sm-5 datetimepk " >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="end_time" name="end_time" class="col-xs-10 col-sm-5 datetimepk " >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox mutex">
                        ...
                        <label>
                            <input name="good_set_mutex[]" type="checkbox" class="ace" value="{{k}}">
