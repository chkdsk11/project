            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="form-group clearfix">
                        <div class="row">
                            <form action="/Adwap/wapList" method="get">
                                <div class="tools-box" >
                                    <label class="clearfix">
                                        名称:<input type="text" style="float:none;" placeholder="请输入入口名称" name="name" value="" class="tools-txt sku_input" />
                                    </label>
                                    <label class="clearfix">
                                        编号:<input type="text" style="float:none;" placeholder="请输入入口编号" name="id" value="" class="tools-txt sku_input" />
                                    </label>
                                        <label class="clearfix">
                                            状态:
                    ...
                    <div>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    {% if v['status'] ==0 %}
                                    <a class="green" href="/HandyEntry/hide?id={{ v['id'] }}"><i class="ace-icon fa fa-file-text"></i>隐藏</a>
                                    {% elseif v['status'] == 1 %}
                                    <a class="green" href="/HandyEntry/show?id={{ v['id'] }}"><i class="ace-icon fa fa-file-text"></i>显示</a>
                                    {% endif %}
                                    |
                                    <a class="green" href="/HandyEntry/wapEdit?id={{ v['id'] }}">
