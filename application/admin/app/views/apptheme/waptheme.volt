                        ...
                        <div class="row">
                            <form action="" method="get">
                                <div class="tools-box" >
                                    ...
                                    <label class="clearfix sku_label"><a class="btn btn-primary" href="/apptheme/wapedit">添加wap主题</a></label>
                    ...
                    <div>
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th class="center sku_menu_row5">主题路径</th>
                                <th class="center sku_menu_row4">开始时间-结束时间</th>
                                <th class="center sku_menu_row5">创建人</th>
                                <th class="center sku_menu_row5">创建时间</th>
                                <th class="center sku_menu_row5">更新时间</th>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <a class="green" href="/apptheme/wapedit?id={{ v['theme_id'] }}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        编辑
                                    </a>
                                    |
                                    <a class="red del" data-id="{{ v['theme_id'] }}" href="javascript:;"><i class="ace-icon fa fa-file-text"></i>删除</a>
                                </td>
                            </tr>
                            {% endfor %}
                            {% else %}
