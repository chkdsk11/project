    ...
    <div class="page-content">
        <div class="row">
            <div class="col-xs-12">
                ...
                <!-- 搜索 -->
                <form action="/smslist/whitelist" method="get">
                    <div class="tools-box">
                        ...
                        <label class="clearfix" style="float: right;">
                            <button class="btn btn-primary" type="button" onclick="showWindow('添加白名单', '/smslist/addwhite', 800, 500, true, true);">添加白名单</button>
                        </label>
                    </div>
                </form>
                            ...
                            {% if data['list'] is defined and data['list'] is not empty %}
                                {% for v in data['list'] %}
                                    <tr>
                                        ...
                                        <td>
                                            <i class="ace-icon glyphicon btn-xs btn-info delWhiteList" data-id="{{ v['list_id'] }}" phone="{{ v['phone'] }}" ip="{{ v['ip_address'] }}" style="cursor: pointer;">解除白名单</i>
                                        </td>
                                    </tr>
                                {% endfor %}
                            {% else %}
