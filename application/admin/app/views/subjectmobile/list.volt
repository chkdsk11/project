            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <div class="top-search">
                        <form class="form-inline" action="/subjectmobile/list" method="post">
						...
						<label class="clearfix sku_label"><a class="btn btn-primary" href="/subjectmobile/add">添加专题</a></label>
                        </form>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="hidden-sm hidden-xs action-buttons">
                                        <a class="green" href="/subjectmobile/add?id={{ v['id'] }}" title="编辑">
                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                        </a>
                                        <a class="blue" href="/subjectmobile/review?id={{ v['id'] }}" title="查看" target="_blank">
...
<script type="text/javascript">
	...
	function stoppost(param){
		$.post("/subjectmobile/stopsubject", {id:param} ,function (data) {
	...
	function copypost(param){
		$.post("/subjectmobile/copysubject", {id:param} ,function (data) {
			if(data.status == 'success'){
					layer_success("操作成功！",'list');
				} else {
					layer_required("操作失败！");
