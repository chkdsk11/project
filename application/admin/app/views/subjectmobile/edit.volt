...
<script>
    document.write('<link rel="stylesheet" href="http://{{ config.domain.static }}/assets/admin/css/subject/special.css?v' + Date.now() + '"/>');
</script>
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="special-box review col-xs-4 col-xs-offset-1">
            <h3 class="title">预览</h3>
            <div class="review-content" id="special-review"></div>
        </div>
        <div class="special-box param col-xs-4 col-xs-offset-1" id="current-widget">
            <script type="text/html">
                <% if(config){ %>
    ...
    <input type="hidden" name="url" value="/subjectmobile/list" placeholder="提交后跳转地址">
...
<script>
    document.write('<scr' + 'ipt src="http://{{ config.domain.static }}/assets/admin/js/subject/special-edit.js?v=' + Date.now() + '"></scr' + 'ipt>');
</script>
