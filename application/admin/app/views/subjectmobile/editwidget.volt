...
<div class="page-content">
    ...
    <div class="row">
        <form action="" class="form-horizontal" action="/subjectmobile/editwidgt" method="post" enctype="multipart/form-data" id='widget_mobile_edit'>
            ...
            {% endif %}
            <input type="hidden" name="channel" value="91" placeholder="渠道号：91:移动端 95:PC">
            <input type="hidden" name="url" value="/subjectmobile/listwidget" placeholder="提交后跳转地址">
