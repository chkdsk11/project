                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="col-xs-10 col-sm-5"  value="{{data['ad_name']}}" placeholder="请输入活动名称" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="start_time" id="start_time"  value="{{ date('Y-m-d H:i:s', data['start_time']) }}"  placeholder="请选择开始时间" class="col-xs-10 col-sm-5"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="end_time" value="{{ date('Y-m-d H:i:s', data['end_time']) }}"  name="end_time" class="col-xs-10 col-sm-5" placeholder="请选择结束时间" />
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    {% if  data['status'] is defined and data['status'] ==1 %}
                                    ...
                                    <table border="1" style="width:60%;" id="ad_imgs" >
                                        ...
                                        {% if data['goods'] %}
                                            {% for v in data['goods'] %}
                                            <tr >
                                                <th class="text-center"><input type="file" id="old_upload_{{ v['id'] }}" data-id="{{ v['id'] }}"  name="old_upload[]" class="old_file" value="修改" /></th>
                                                <th class="text-center"><input name="old_location[{{ v['id'] }}]" class="location" value="{{v['location']}}" style="width:350px;" /></th>
                                                <th class="text-center">
                                                    <img style="width: 120px; height:120px;" id="oldimage_{{ v['id'] }}"  src="{{ v['image_url'] }}" />
                                                    <input type="hidden" id="oldimage_url_{{ v['id'] }}" name="oldimage_url[{{ v['id'] }}]" value="{{v['image_url']}}"/>
                                                </th>
                                                <th class="text-center"><input name="old_sort[{{ v['id'] }}]" style="width:50px;" class="sort" value="{{ v['sort'] }}" /> </th>
                                                <th class="text-center"><input type="button" value="删除" onclick="deletad({{ v['id'] }})" class="btn"></th>
                                            </tr>
                                            {% endfor %}
                                        {% endif %}
                                    </table>
