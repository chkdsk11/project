            ...
            <div class="col-xs-12">
                ...
                <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                {% if v['provider_state'] == 0 %}
                                    <input type="text" name="{{ v['provider_id'] }}" value="{{ v['scale'] }}" class="col-xs-10 col-sm-5" placeholder="不可为空"/>
                                {% else %}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <span class="col-sm-9" style="color: red;">比例之和必须为1，否则设置无效</span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right"></label>
                        <div class="col-sm-9">
                            <button class="btn btn-info" id="editScale">
