...
<div class="main-container" id="main-container">
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <form id="addPromotionForm"  class="form-horizontal" action="/cpschannel/copy?act_id={% if act_id is defined and act_id  %}{{ act_id }}{%endif%}" method="post" onsubmit="ajaxSubmit(addPromotionForm);return false;">
                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            ...
                            <div class="form-group" id="goods_add" {% if list['activity']['type_id']!= 4  %} style="display:none" {%endif%}  >
                                ...
                                <div class="col-sm-9">
                        		  ...
                        		  <span class="btn btn-primary" id="btn_search" disabled>搜索</span>
                                </div>
                            </div>
                                  ...
                                  <tbody id="rule-tbody">
                                    	...
                                    	{% for v in list['activity']['relation_list'] %}
                  										<tr>
                  											...
                  											<div class="input-group col-md-5">
                  											<input value="{{v['belong_id']}}" name="item_list[]" type="hidden">
                  											<input class="form-control" style="width:95px;" placeholder="输入返利比例" value="{{v['first_rebate']}}" disabled type="text">
                                        <input name="first_rebates[]" value="{{v['first_rebate']}}" type="hidden">
                  											<div class="input-group-addon">%</div>
                  											</div>
                  											</td>
                  											...
                  											<input class="form-control" style="width:95px;" placeholder="输入返利比例" value="{{v['back_percent']}}" disabled type="text">
                                        <input name="back_percents[]" value="{{v['back_percent']}}" type="hidden">
                  											<div class="input-group-addon">%</div>
                  											</div>
                  											</td>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="promotion_copywriter">分享标题（活动标题）</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="promotion_copywriter">分享描述（活动描述）</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="promotion_copywriter">分享链接</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
								{% if p_id is defined and p_id == 'ck' %}
