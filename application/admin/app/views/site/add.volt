...
<form id="site_form" class="form-horizontal" role="form" action="" method="post">
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">站点名称</label>

        <div class="col-sm-9">
            <input type="text" id="site_name" name="site_name" id="form-field-1" placeholder="站点名称" class="col-xs-10 col-sm-5" value="" />
        </div>
    </div>
    <div class="form-group">
            ...
            <div class="control-group">
                ...
                <div class="checkbox">
                    <label style="margin-left:15px;">
                        <input name="menu_id[]" value="{{ vv['id'] }}" data-pid="{{ val['id'] }}" class="ace ace-checkbox-2" type="checkbox" />
    ...
    <div class="col-md-offset-3 col-md-9">
        <input  class="btn btn-lg btn-yellow" id="saveBtn" type="button" value="提交" name="submit" />
    </div>
</form>
{% endblock %}
{% block footer %}
