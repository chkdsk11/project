                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox promotion_platform">
                                    <label>
                                        <input name="is_default" type="radio" class="ace" value="1"  {% if info['is_default'] == 1 %} checked {% endif%}>
                                        <span class="lbl">&nbsp;是</span>
                                    </label>
                                    <label>
                                        <input name="is_default" type="radio" class="ace" value="0" {% if info['is_default'] == 0 %} checked {% endif%} >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        ...
                                        <table width="90%" border="0" style="text-align:left" id="product_list">
                                            ...
                                            <tr >
                                                <th width="10%"><input type='hidden' name='product_id[]' value="{{p['product_id']}}"/> {{p['product_id']}}</th>
                                                <th width="45%">{{p['product_name']}}</th>
                                                <th width="20%"">
                                                ...
                                                <th width="15%"><input type='text' name="order_product[{{p['product_id']}}]" value="{{p['sort']}}" class='product_order' size='5'></th>
                                                <th width="10%"">&nbsp;<input type="button" value="删除" onclick="deleteok(this)" class="btn"></th>
                                            </tr>
                                            {% endfor %}
                                            {% endif %}
                                        </table>
                            ...
                            <div id="TD" {% if info['advertisement_type'] ==3 %} style="display: block;"{% else %} style="display: none;" {% endif%} >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <input type="text"  style="width:80%" value="{% if info['slogan'] is defined %}{{ info['slogan'] }}{% endif%}" id="slogan_text" name="slogan_text" placeholder="请输入文字"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> 目标地址： </label>
                                    <div class="col-xs-12 col-sm-9">
                                        <input type="text"  style="width:80%" value="{% if info['slogan'] is defined %}{{ info['location'] }}{% endif%}" id="location_text" name="location_text" placeholder="请输入目标地址"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right"> 排序： </label>
                                    <div class="col-xs-12 col-sm-9">
                                        <input type="text"  name="order_text" id="order_text" value="{% if info['order'] is defined %}{{ info['order'] }}{% endif%}"  placeholder="请输入排序"/>
                                    </div>
                                </div>
                            </div>
                            <!--  文字推荐 end -->
...
<script src="http://{{ config.domain.static }}/assets/admin/js/ad/edit.js"></script>
