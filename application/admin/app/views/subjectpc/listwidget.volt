...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="top-search">
            <form class="form-inline" action="/subjectpc/listwidget" method="post">
        ...
        <div class="special-table">
            <table id="simple-table" class="table  table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="hidden-480">
                        <label class="pos-rel">
                            <input type="checkbox" class="ace pc-widget-status" value="{{ v['component_id'] }}" name="status[{{v['component_id']}}]" {% if v['status'] == 1 %}checked="true"{% endif %} >
                            <span class="lbl"></span>
                        </label>
                    </td>
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            <a class="green" href="/subjectpc/editwidget?id={{ v['component_id'] }}" title="编辑">
