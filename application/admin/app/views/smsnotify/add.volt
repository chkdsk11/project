            ...
            <div class="col-xs-12">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">通知人</label>
                        <div class="col-sm-9">
                            <input type="text" name="user_name" class="col-xs-10 col-sm-6" placeholder="不可为空"/>   
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="phone" class="col-xs-10 col-sm-6" placeholder="不可为空"/>   
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <button class="btn btn-info" id="addNotify">
