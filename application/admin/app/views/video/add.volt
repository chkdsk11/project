        ...
        <div class="col-xs-12">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea name="content" id="content" class="col-xs-10 col-sm-5"></textarea>
                    </div>
                </div>
                <div class="tools-box" style="padding: 0;">
                    <input type="button" class="btn btn-primary" id="uploadBtn" value="开始上传" />
                    <input type="button" id='fileSelecter' class="btn btn-primary" value="选择视频" />
                </div>
            </div>
        </div><!-- /.col -->
    </div><!-- /.row -->
...
<!--上传文件-->
<script src="http://{{ config.domain.static }}/assets/admin/js/video/Gandalf.js?<?php echo time(); ?>"></script>
<script src="http://{{ config.domain.static }}/assets/admin/js/video/sds_sdk.js?<?php echo time(); ?>"></script>
<script src="http://{{ config.domain.static }}/assets/admin/js/video/globalvideo.js?<?php echo time(); ?>"></script>
</body>
