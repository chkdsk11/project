            ...
            <form class="form-horizontal" role="form" id="insert_coupon" method="post" action="/coupon/add" enctype="multipart/form-data" >
               ...
               <input type="hidden" id="use_platform_hidden">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="app_url" name="app_url" placeholder="此处输入APP链接" class="col-xs-10 col-sm-9 checkURL" style="margin-right:5px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="wap_url" name="wap_url" placeholder="此处输入WAP链接" class="col-xs-10 col-sm-9 checkURL" style="margin-right:5px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="pc_url" name="pc_url" placeholder="此处输入PC链接" class="col-xs-10 col-sm-9 checkURL" style="margin-right:5px;">
                <span  class="text-red">如:http://www.baidu.com</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" id="wechat_url" name="wechat_url" placeholder="此处输入微商城链接" class="col-xs-10 col-sm-9 checkURL" style="margin-right:5px;">
