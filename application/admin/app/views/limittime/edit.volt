...
<div class="main-container" id="main-container">
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <form id="addLimitPromotionForm"  class="form-horizontal" action="/limittime/edit" method="post" onsubmit="ajaxSubmit(addLimitPromotionForm);return false;">
                <div class="">
                    <h3>
                        基本信息
                    </h3>
                        ...
                        <div>
                                ...
                                <div class="checkbox promotion_platform">
                                    {% if shopPlatform is defined and shopPlatform is not empty %}
                                        {% for key,platform in shopPlatform %}
                                            ...
                                            <label>
                                                <input name="promotion_platform_{{ key }}" type="checkbox" class="ace" {% if limitPromotionDetail[promotionKey] is defined %}value="{{ limitPromotionDetail[promotionKey] }}" {% if limitPromotionDetail[promotionKey] == 1 %}checked{% endif %}{% endif %} >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <select id="offer_type" name="offer_type">
                                        ...
                                        <option value="{{k}}" {% if limitPromotionDetail['offer_type'] is defined and limitPromotionDetail['offer_type'] == k %}selected{% endif %}>{{v}}</option>
                                        {% endfor %}
                                        {% endif %}
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox promotion_mutex">
                                    ...
                                    <label>
                                        <input name="promotion_mutex[]" type="checkbox" {% if limitPromotionDetail['promotion_mutex'] is defined and in_array(k,limitPromotionDetail['promotion_mutex']) %}checked{% endif %} class="ace" value="{{k}}">
                            ...
                            <input type='hidden' name='shop_single' id='shop_single' value=''>
                            ...
                            <!-- 模板隐藏域赋值start -->
                            <input id="limitTimeGoods" type="hidden" value='{% if limitTimeGoods is defined %}{{limitTimeGoods}}{% endif %}' />
                            <!-- 模板隐藏域赋值end -->
                            <input id="offer_goods" name='offer_goods' type="hidden">
                ...
                <div class="clearfix form-actions">
                    <div class="col-md-offset-3 col-md-9">
                        <button id="addLimitPromotion" class="btn btn-info" type="button" {% if sign is defined and sign == 0 %}disabled{% endif %}>
                            <i class="ace-icon fa fa-check bigger-110"></i>
                            保存
                        </button>
                        &nbsp; &nbsp; &nbsp;
...
<script type="text/javascript">
    var limitTimeGoods=$("#limitTimeGoods").val();
    var limitTimeGoods_arr= $.parseJSON(limitTimeGoods);
    ...
    switch (offer_type){
        case "1":
                var single_sid_arr=[];
            $.each(limitTimeGoods_arr,function (n,v) {
                if(v['is_unified_price'] == '0'){
                    var v_offers = v["discount"];
                    if(v["discount"]['pc']){
                         v_offers = '';
                        is_show_msg = 1;
                    }
                    $("#JgoodsTabTbody").append('<tr data-is_unified_price="0"><td>'+v["id"]+'</td><td>'+v["goods_name"]+'</td><td>统一价:'+v["price"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-sid = "'+v["id"]+'" value="'+v_offers+'"></td><td><input type="text" class="discount_price" placeholder="价格" disabled></td><td><a class="del_js" href="javascript:void(0);" style="text-decoration: none;">删除</a></td></tr>');
                }else{
                    var $that = $(this);
                    $.each(platform,function (n,b) {
                        var delStr = '';
                        ...
                        if(n == 0){
                            ...
                            headStr = '<tr data-is_unified_price="1"><td>'+v["id"]+'</td><td>'+v["goods_name"]+'</td>';
                        }
                       switch (b)
                       {
                           case 'pc':
                               $("#JgoodsTabTbody").append(headStr+'<td>pc：'+v["goods_price_pc"]+'</td><td><input type="text" class="discount_num" data-platform = "pc" placeholder="几折" value="'+v['discount']['pc']+'"  data-sid = "'+v["id"]+'"></td><td><input type="text" class="discount_price" data-platform = "pc" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                               break;
                           case 'app':
                               $("#JgoodsTabTbody").append(headStr+'<td>app：'+v["goods_price_app"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "app" value="'+v["discount"]["app"]+'" data-sid = "'+v["id"]+'"></td><td><input type="text" class="discount_price" data-platform = "app" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                               break;
                           case 'wap':
                               $("#JgoodsTabTbody").append(headStr+'<td>wap：'+v["goods_price_wap"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "wap" value="'+v["discount"]["wap"]+'" data-sid = "'+v["id"]+'"></td><td><input type="text" class="discount_price" data-platform = "wap" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                               break;
                           case 'wechat':
                               $("#JgoodsTabTbody").append(headStr+'<td>微商城：'+v["goods_price_wechat"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "wechat" value="'+v["discount"]["wechat"]+'" data-sid = "'+v["id"]+'"></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "wechat" disabled></td><td>'+delStr+'</td></tr>');
                               break;
                       }
                    });
                }
                ...
                if(v["is_unified_price"] == "0"){
                    $("#discountRight").append('<li><a href="javascript:;" data-id="'+v['id']+'" data-pname="'+v["goods_name"]+'" data-price='+v['price']+' data-is_unified_price="'+v["is_unified_price"]+'"><span class=pro-name>'+v['goods_name']+'</span><span class=pro-price>原价：'+v['price']+'</span></a></li>');
                }else{
                    $("#discountRight").append('<li><a href="javascript:;" data-id="'+v['id']+'" data-pname="'+v["goods_name"]+'" data-price='+v['price']+' data-is_unified_price="'+v["is_unified_price"]+'" data-goods_price_pc="'+v["goods_price_pc"]+'" data-goods_price_app="'+v["goods_price_app"]+'" data-goods_price_wap="'+v["goods_price_wap"]+'" data-goods_price_wechat="'+v["goods_price_wechat"]+'"><span class=pro-name>'+v['goods_name']+'</span><span class=pro-price>pc价格：'+v['goods_price_pc']+'元,app价格:'+v["goods_price_app"]+'元,wap价格:'+v["goods_price_wap"]+'元,微商城价格:'+v["goods_price_wechat"]+'元</span></a></li>');
                }
                single_sid_arr.push(v["id"]);
            });
            $('#shop_single').val(single_sid_arr.join(","));
            break;
        case "2":
            var single_sid_arr=[];
            $.each(limitTimeGoods_arr,function (n,v) {
                if(v['is_unified_price'] == '0'){
                    var v_offers = v["offers"];
                    if(v["offers"]['pc']){
                        v_offers = '';
                        is_show_msg = 1;
                    }
                    $("#JgoodsTabTbody").append('<tr data-is_unified_price="0"><td>'+v["id"]+'</td><td>'+v["goods_name"]+'</td><td>统一价'+v["price"]+'</td><td><input type="text" class="discount_num" placeholder="几折" disabled></td><td><input type="text" class="discount_price" placeholder="价格" value="'+v_offers+'" data-sid = "'+v["id"]+'"></td><td><a class="del_js" href="javascript:void(0);" style="text-decoration: none;">删除</a></td></tr>');
                }else{
                    $.each(platform,function (n,b) {
                        var delStr = '';
                        var headStr = '<tr><td></td><td></td>';
                        ...
                        {
                            case 'pc':
                                $("#JgoodsTabTbody").append(headStr+'<td>pc：'+v["goods_price_pc"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "pc" disabled></td><td><input type="text" class="discount_price" data-platform = "pc" placeholder="价格" value="'+v["offers"]['pc']+'" data-sid = "'+v["id"]+'"></td><td>'+delStr+'</td></tr>');
                                break;
                            case 'app':
                                $("#JgoodsTabTbody").append(headStr+'<td>app：'+v["goods_price_app"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "app" disabled></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "app" value="'+v["offers"]['app']+'" data-sid = "'+v["id"]+'"></td><td>'+delStr+'</td></tr>');
                                break;
                            case 'wap':
                                $("#JgoodsTabTbody").append(headStr+'<td>wap：'+v["goods_price_wap"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "wap" disabled></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "wap" value="'+v["offers"]['wap']+'" data-sid = "'+v["id"]+'"></td><td>'+delStr+'</td></tr>');
                                break;
                            case 'wechat':
                                $("#JgoodsTabTbody").append(headStr+'<td>微商城：'+v["goods_price_wechat"]+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "wechat" disabled></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "wechat" value="'+v["offers"]['wechat']+'" data-sid = "'+v["id"]+'"></td><td>'+delStr+'</td></tr>');
                                break;
                        }
                    });
    ...
    if(is_show_msg == 1){
        layer_required('因有商品数据进行改动，因此价格方面需要您手动调整');
    }
    //初始化加载单品
    ...
    $("#sure_btn").on("click", function () {
        ...
        if(discountRight_len > 0){
            var shop_single_val=$("#shop_single").val();
            var shop_single_val_arr=shop_single_val.split(",");
            if($("#JgoodsTabTbody tr").length >0){
                $("#discountRight li a").each(function () {
                    var id=$(this).data("id");
                    var __s=-1;
                    $.each(shop_single_val_arr,function (n,v) {
                        if(id==v){
                            __s=n;
                        }
                    })
                            ...
                            if(__s == -1){
                                if($(this).data('is_unified_price') == '0'){
                                    ...
                                    $.each(platform,function (n,v) {
                                        ...
                                        {
                                            case 'pc':
                                                JgoodsTabTbody.append(headStr+'</td><td>pc：'+$that.data('goods_price_pc')+'</td><td><input type="text" class="discount_num" data-platform = "pc" placeholder="几折" data-sid = "'+$that.data('id')+'"></td><td><input type="text" class="discount_price" data-platform = "pc" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                                                break;
                                            case 'app':
                                                JgoodsTabTbody.append(headStr+'<td>app：'+$that.data('goods_price_app')+'</td><td><input type="text" class="discount_num" data-platform = "app" placeholder="几折" data-sid = "'+$that.data('id')+'"></td><td><input type="text" class="discount_price" data-platform = "app" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                                                break;
                                            case 'wap':
                                                JgoodsTabTbody.append(headStr+'<td>wap：'+$that.data('goods_price_wap')+'</td><td><input type="text" class="discount_num" data-platform = "wap" placeholder="几折" data-sid = "'+$that.data('id')+'"></td><td><input type="text" class="discount_price" data-platform = "wap" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                                                break;
                                            case 'wechat':
                                                JgoodsTabTbody.append(headStr+'<td>微商城：'+$that.data('goods_price_wechat')+'</td><td><input type="text" class="discount_num" data-platform = "wechat" placeholder="几折" data-sid = "'+$that.data('id')+'"></td><td><input type="text" class="discount_price" data-platform = "wechat" placeholder="价格" disabled></td><td>'+delStr+'</td></tr>');
                                                break;
                                        }
                                    });
                                }
                            ...
                            if(__s == -1){
                                if($(this).data('is_unified_price') == '0'){
                                    ...
                                    $.each(platform,function (n,v) {
                                        ...
                                        {
                                            case 'pc':
                                                JgoodsTabTbody.append(headStr+'</td><td>pc：'+$that.data('goods_price_pc')+'</td><td><input type="text" class="discount_num" placeholder="几折" data-platform = "pc" disabled></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "pc" data-sid = "'+$that.data('id')+'"></td><td>'+delStr+'</td></tr>');
                                                break;
                                            case 'app':
                                                ...
                                                break;
                                            case 'wap':
                                                JgoodsTabTbody.append('<tr><td></td><td></td><td>wap：'+$that.data('goods_price_wap')+'</td><td><input type="text" class="discount_num" data-platform = "wap" placeholder="几折" disabled></td><td><input type="text" class="discount_price" placeholder="价格" data-platform = "wap" data-sid = "'+$that.data('id')+'"></td><td>'+delStr+'</td></tr>');
                                                break;
                                            case 'wechat':
