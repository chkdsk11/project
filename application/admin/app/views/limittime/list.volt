...
<link rel="stylesheet" href="http://{{ config.domain.static }}/assets/css/jquery.datetimepicker.css" class="ace-main-stylesheet" />
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form action="/limittime/list" method="get">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a title="查看" {% if v['promotion_status'] == '未开始' %}style="display:none;"{% endif %} class="blue" href="/limittime/edit?promotion_id={{ v['promotion_id'] }}&sign=0">
                                                        <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                                    </a>
                                                    <a title="编辑" {% if v['promotion_status'] != '未开始' %}style="display:none;"{% endif %} class="green" href="/limittime/edit?promotion_id={{ v['promotion_id'] }}&sign=1">
...
<script src="http://{{ config.domain.static }}/assets/admin/js/promotion/limitTimeList.js"></script>
{% endblock %}