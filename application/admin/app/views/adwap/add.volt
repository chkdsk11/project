                    ...
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    <select name="adp_id" id="adp_id">
                                        ...
                                        <option value="{{v['id']}}" data-type="{{v['adposition_type']}}">{{v['adpositionid_name']}}</option>
                                        {% endfor %}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="PD" style="display: block;">
                                ...
                                <div class="form-group navimg" style="display: none;">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        ...
                                        <img src="" id="change_image" class="img-rounded">
                                        <input type="hidden" name="change_image" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group navimg" style="display: none;">
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        <input class="col-xs-10 col-sm-5" type="text" name="changet_second_image" id="changet_second_image" style="width:80%" placeholder="上传或填写URL二选一"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="member_tag"> 背景色： </label>
                                    <div class="col-xs-12 col-sm-9">
                                        <input type="text" name="background"  id="picker" value="#66CCFF" />
                                    </div>
                                </div>
                                <div class="form-group">
